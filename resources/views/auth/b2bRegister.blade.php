...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('B2B Register Form') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('b2b.signupSubmit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="Business Category" class="col-md-4 col-form-label text-md-right">{{ __('B2B Category') }}</label>
                            <div class="col-md-6">
