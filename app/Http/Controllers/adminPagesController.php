...
class adminPagesController extends Controller
{
    ...
    public function hotelAdd(){
        ...
        return view('backend.admin.pages.hotelAdd');
    }
    ...
    public function hotelAddSubmit(Request $request){
        ...
        return redirect()->route('admin.hotelAdd');
    ...
    public function hotelRoom(){
        ...
        return view('backend.admin.pages.hotelRoom')->with('hotel' , $hotel);
    ...
    public function hotelRoomSubmit(Request $request){
        ...
        if ($request->hasFile('image')) {
          ...
          $image = $request->file('image');
          $img = $image->getClientOriginalName();
          $location = 'images/hotel_rooms/' .$img;
          Image::make($image)->save($location);
        ...
        return redirect()->route('admin.hotelRoom');
