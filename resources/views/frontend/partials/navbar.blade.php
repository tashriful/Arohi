<nav style="margin-bottom:0;background-color:#02517C" id="navbar" class="navbar navbar-expand-md navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul style="margin-left:10%;" class="navbar-nav ">
                ...
                <li class="nav-item">
                    <a style="color:white" class="nav-link" href="{{ route('homepage') }}">HOTEL</a>
                </li>
                <li class="nav-item">
                    <a style="color:white" class="nav-link" href="{{ route('homepage') }}">RESORTS</a>
                </li>
                <li class="nav-item">
                    <a style="color:white" class="nav-link" href="{{ route('pick') }}">PICK & DROP</a>
                </li>
                <li class="nav-item">
                    <a style="color:white" class="nav-link" href="{{ route('air') }}">AIR TICKET</a>
                </li>
                <li class="nav-item">
